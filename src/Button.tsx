...
const Button: FC<ButtonProps> = (props) => {
  ...
  const colors = {
    amber: `${
      props.outlined
        ? 'border border-amber-500 text-amber-500 hover:text-white'
    ...
    cyan: `${
      props.outlined
        ? 'border border-cyan-500 text-cyan-500 hover:text-white'
        : 'bg-cyan-600 text-white'
    } hover:bg-cyan-700 focus:ring-cyan-500`,
    emerald: `${
      props.outlined
        ? 'border border-emerald-500 text-emerald-500 hover:text-white'
        : 'bg-emerald-600 text-white'
    } hover:bg-emerald-700 focus:ring-emerald-500`,
    fuchsia: `${
      props.outlined
        ? 'border border-fuchsia-500 text-fuchsia-500 hover:text-white'
        : 'bg-fuchsia-600 text-white'
    } hover:bg-fuchsia-700 focus:ring-fuchsia-500`,
    green: `${
      props.outlined
    ...
    indigo: `${
      props.outlined
        ? 'border border-indigo-500 text-indigo-500 hover:text-white'
        : 'bg-indigo-600 text-white'
    } hover:bg-indigo-700 focus:ring-indigo-500`,
    lime: `${
      props.outlined
        ? 'border border-lime-500 text-lime-500 hover:text-white'
        : 'bg-lime-600 text-white'
    } hover:bg-lime-700 focus:ring-lime-500`,
    orange: `${
      props.outlined
    ...
    pink: `${
      props.outlined
        ? 'border border-pink-500 text-pink-500 hover:text-white'
        : 'bg-pink-600 text-white'
    } hover:bg-pink-700 focus:ring-pink-500`,
    purple: `${
      props.outlined
        ? 'border border-purple-500 text-purple-500 hover:text-white'
    ...
    rose: `${
      props.outlined
        ? 'border border-rose-500 text-rose-500 hover:text-white'
        : 'bg-rose-600 text-white'
    } hover:bg-rose-700 focus:ring-rose-500`,
    sky: `${
      props.outlined
    ...
    teal: `${
      props.outlined
        ? 'border border-teal-500 text-teal-500 hover:text-white'
        : 'bg-teal-600 text-white'
    } hover:bg-teal-700 focus:ring-teal-500`,
    violet: `${
      props.outlined
        ? 'border border-violet-500 text-violet-500 hover:text-white'
    ...
    secondary: `${
      props.outlined
        ? 'border border-secondary-500 text-secondary-500 hover:text-white'
        : 'bg-secondary-600 text-white'
    } hover:bg-secondary-700 focus:ring-secondary-500`,
    danger: `${
      props.outlined
        ? 'border border-danger-500 text-danger-500 hover:text-white'
  ...
  return (
    <>
      <button
        ...
        } flex justify-center py-2 px-4 border rounded shadow-sm text-sm font-medium ${
          colors[props.color]
